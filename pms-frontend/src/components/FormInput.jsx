...
const FormInput = ({ placeholder, type, id, register }) => {

  return (
    <div className='relative'>
      <input type={type} id={id} className="block px-2.5 pb-2.5 pt-4 w-full bg-transparent rounded-lg border border-zinc-500 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" {...register} placeholder="" />
